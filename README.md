...
Target-specific research, tooling, and analysis for **Pocket Monsters Aka / Pokémon Red**.
...
| Intended scope | Japanese and localized releases, with the supported revision matrix established from verified hashes. |

...
Evidence-driven disassembly research for **Pocket Monsters Aka / Pokémon Red**.
...
| Scope | Japanese and localized Red releases; every supported revision must be hash-verified. |
